"""
Production settings for estimate management application
"""
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        'OPTIONS': {'min_length': 12}  # Increased for production
    },
    {
...
CORS_ALLOWED_ORIGINS = [origin for origin in os.environ.get('CORS_ALLOWED_ORIGINS', '').split(',') if origin.strip()]
...
# Backup settings
BACKUP_LOCAL_DIRECTORY = os.environ.get('BACKUP_DIR', '/backups')
